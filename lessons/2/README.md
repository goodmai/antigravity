...
## Глубокое понимание артефактов

### Жизненный цикл артефакта

1. **Создание** - Агент анализирует задачу и создает artifact
2. **Отображение** - Вы видите артефакт в интерфейсе
3. **Обратная связь** - Вы комментируете и правите
4. **Обновление** - Агент обновляет на основе ваших комментариев
5. **Одобрение** - Вы одобряете (LGTM) и переходим к выполнению
6. **Завершение** - Создается финальный отчет

### Best Practices

- Всегда комментируйте план перед одобрением
- Используйте inline comments для локальных предложений
- Одобряйте после изучения всех деталей
- Запрашивайте улучшения, если что-то не ясно
