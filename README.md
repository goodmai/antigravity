...
| [`smartcontracts/e2e/`](./smartcontracts/e2e/) | **THE main check** — real-network E2E (anvil-BNB + Greenfield testnet + Lit datil-test); see §1 below |
...
The funded holder addresses are above (anvil dev accounts on chain 97;
the operator-supplied `GREENFIELD_TESTNET_ADDRESS` on chain 5600).
...
2. **Lit-wrap (real datil-test)** — master is encrypted under
